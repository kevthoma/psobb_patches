...
namespace Corellia
{
    ...
    class MainForm : Form
    {
        ...
        void BuildUI()
        {
            ...
            // Remember the create-game party name and password. OFF by default: the password is a
            // secret at rest, and a restore that goes wrong changes who can join a game. Opt-in
            // matches what Ephinea does with the same feature.
            cbRememberParty = new CheckBox { Text = "Remember party name and password",
